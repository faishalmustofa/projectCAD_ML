...
% (3) If at least one MAA exceeds three times the median value of the MAAs,
...
ori_signal = reshape(original_signal(length(despiked_signal)+1:end),[],1);
% Add the trailing samples back to the signal:
despiked_signal = [despiked_signal; ori_signal];
